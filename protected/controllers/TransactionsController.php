...
// ----------------------------
	...
	{
		//$sql="SELECT (wb_out - wb_in) FROM tbl_transactions AS tots where id=$data->id";
		//$command=Yii::app()->db->createCommand($sql)->queryAll();
		//$command = Yii::app()->db->createCommand();
		//$weight = $command->select("(wb_out - wb_in) from tbl_transactions as tots where id=$data->id")->from('tbl_transactions')->queryAll();
		$row = Yii::app()->db->createCommand(array(
		    'select' => array('(wb_out - wb_in) as num'),
